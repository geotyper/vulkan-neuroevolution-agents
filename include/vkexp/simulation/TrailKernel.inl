...
// Ground resolution in metres. This is not a free parameter: the three antenna
// tips have to land in different cells for a reading to carry a gradient, and
// BrainAntennaLength/HalfSpread put the outer tips 15 cm apart. At 6 cm the
// spread covers two to three cells.
const float TrailCellSize = 0.06f;
